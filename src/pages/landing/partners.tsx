    ...
    <>
      <div className="relative w-screen">
        ...
        <img
          src={star}
          alt="star"
          className="absolute md:bottom-[24%] md:right-[42%]"
        />
        <img
          src={gradientstar}
          alt="gradientstar"
        ...
        <img
          src={starsecondary}
          alt="starsecondary"
          className="absolute md:top-[20%] md:left-[12%]"
        />
        <img
          src={partnerflare1}
          alt="partner flare"
          className="absolute top-0 left-0 blur-lg opacity-50 md:-ml-[231px]"
        />
        <img
          src={partnerflare2}
          alt="partner flare"
          className="absolute bottom-0 right-0 blur-lg opacity-50 md:-mr-[200px] md:-mb-[296px]"
        />
        <div className="flex items-center justify-center md:mt-24 md:mb-[64px]">
          <div>
            <h3 className="font-clash text-center md:mb-5 md:text-[32px] font-bold">
              Partners and Sponsors
            </h3>
            <div className="md:max-w-[452px] text-center md:text-sm">
